...
class TestStoredDecisionSerialization:
    ...
    def test_to_json(self):
        ...
        assert json_data["coordinate"]["x"] == 5
    ...
    def test_from_json(self):
        ...
        assert decision.coordinate.x == 5
    ...
    def test_json_roundtrip(self):
        ...
        coord = VectorCoordinate(x=42, y=3, z=2)
...
class TestMemoryLayer:
    ...
    def test_validate_write_immutable_empty(self):
    ...
    def test_validate_write_immutable_occupied(self):
    ...
    def test_validate_write_mutable_occupied(self):
        """Test writing to occupied mutable layer (allowed)."""
        layer = MemoryLayer.IMPLEMENTATION
        coord = VectorCoordinate(x=5, y=3, z=3)
        existing = StoredDecision(
            coordinate=coord,
            content="Existing",
            timestamp=datetime.now(),
    ...
    def test_validate_delete(self):
        ...
        coord = VectorCoordinate(x=5, y=2, z=4)
